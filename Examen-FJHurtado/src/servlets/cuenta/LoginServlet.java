		...
		if (session != null) {
              ...
              // d. Error: la contraseña no es válida
            	...
            	//Conexion, consulta y muestra de datos
  				...
  				try {
  				  ...
  				  String consulta = "SELECT * from cliente where login='"+loginname+"' and password='"+loginpassword+"' ";
  	    ...
  	    // 1. Crear un objeto de la clase Usuario con los datos obtenidos de la BD	  
  					//CREAR OBJETOS			  
  								  ...
  								  String ngasto=rset.getString("gasto");
  								  String ndireccion=rset.getString("direccion");
  								  
  								  Usuario usuario = new Usuario(nlogin, npassword, nnombre, ngasto, ndireccion);
